...
## Project Structure
    ...
    ├── tst_dani_prod_rel_31446  # Django project configurations
...
1. Clone this repo and `cd tst_dani_prod_rel_31446`
...
2. Clone this repo and `cd tst_dani_prod_rel_31446`
